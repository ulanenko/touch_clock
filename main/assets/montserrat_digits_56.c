 ...
 * Size: 56 px
 * Bpp: 4
 * Opts: --size 56 --bpp 4 --format lvgl --font managed_components/lvgl__lvgl/scripts/built_in_font/Montserrat-Medium.ttf --symbols 0123456789: --no-kerning --no-compress --lv-font-name montserrat_digits_56 -o main/assets/montserrat_digits_56.c
 ******************************************************************************/

#include "lvgl.h"

#ifndef MONTSERRAT_DIGITS_56
#define MONTSERRAT_DIGITS_56 1
#endif

#if MONTSERRAT_DIGITS_56
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 598, .box_w = 33, .box_h = 39, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 644, .adv_w = 332, .box_w = 15, .box_h = 39, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 937, .adv_w = 514, .box_w = 31, .box_h = 39, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 1542, .adv_w = 513, .box_w = 30, .box_h = 39, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 2127, .adv_w = 599, .box_w = 35, .box_h = 39, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 2810, .adv_w = 514, .box_w = 31, .box_h = 39, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 3415, .adv_w = 553, .box_w = 32, .box_h = 39, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 4039, .adv_w = 536, .box_w = 31, .box_h = 39, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 4644, .adv_w = 577, .box_w = 32, .box_h = 39, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 5268, .adv_w = 553, .box_w = 31, .box_h = 39, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 5873, .adv_w = 203, .box_w = 9, .box_h = 30, .ofs_x = 2, .ofs_y = 0}
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t montserrat_digits_56 = {
#else
lv_font_t montserrat_digits_56 = {
#endif
