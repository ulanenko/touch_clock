 ...
 * Size: 72 px
 * Bpp: 4
 * Opts: --size 72 --bpp 4 --format lvgl --font managed_components/lvgl__lvgl/scripts/built_in_font/Montserrat-Medium.ttf --symbols 0123456789+-=  --no-kerning --no-compress --lv-font-name montserrat_math_72 -o main/assets/montserrat_math_72.c
 ******************************************************************************/

#include "lvgl.h"

#ifndef MONTSERRAT_MATH_72
#define MONTSERRAT_MATH_72 1
#endif

#if MONTSERRAT_MATH_72
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 544, .adv_w = 441, .box_w = 20, .box_h = 7, .ofs_x = 4, .ofs_y = 17},
    {.bitmap_index = 614, .adv_w = 768, .box_w = 42, .box_h = 53, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 1727, .adv_w = 426, .box_w = 20, .box_h = 51, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 2237, .adv_w = 661, .box_w = 38, .box_h = 52, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 3225, .adv_w = 659, .box_w = 38, .box_h = 52, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 4213, .adv_w = 771, .box_w = 46, .box_h = 51, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 5386, .adv_w = 661, .box_w = 38, .box_h = 52, .ofs_x = 1, .ofs_y = -1},
    {.bitmap_index = 6374, .adv_w = 711, .box_w = 40, .box_h = 53, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 7434, .adv_w = 689, .box_w = 39, .box_h = 51, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 8429, .adv_w = 742, .box_w = 41, .box_h = 53, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 9516, .adv_w = 711, .box_w = 39, .box_h = 53, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 10550, .adv_w = 670, .box_w = 34, .box_h = 23, .ofs_x = 4, .ofs_y = 14}
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t montserrat_math_72 = {
#else
lv_font_t montserrat_math_72 = {
#endif
