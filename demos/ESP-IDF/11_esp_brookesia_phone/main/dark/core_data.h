    ...
    {                                                                                                \
        ...
        .container = {                                                                               \
            .styles = {                                                                              \
                {                                                                                    \
                    .outline_width = 1,                                                              \
                    .outline_color = ESP_BROOKESIA_STYLE_COLOR(0xeb3b5a),                            \
                },                                                                                   \
                {                                                                                    \
                    .outline_width = 2,                                                              \
                    .outline_color = ESP_BROOKESIA_STYLE_COLOR(0xfa8231),                            \
                },                                                                                   \
                {                                                                                    \
                    .outline_width = 1,                                                              \
                    .outline_color = ESP_BROOKESIA_STYLE_COLOR(0xf7b731),                            \
                },                                                                                   \
                {                                                                                    \
                    .outline_width = 2,                                                              \
                    .outline_color = ESP_BROOKESIA_STYLE_COLOR(0x20bf6b),                            \
                },                                                                                   \
                {                                                                                    \
                    .outline_width = 1,                                                              \
                    .outline_color = ESP_BROOKESIA_STYLE_COLOR(0x0fb9b1),                            \
                },                                                                                   \
                {                                                                                    \
                    .outline_width = 2,                                                              \
                    .outline_color = ESP_BROOKESIA_STYLE_COLOR(0x2d98da),                            \
                },                                                                                   \
            },                                                                                       \
        },                                                                                           \
    }
...
#define ESP_BROOKESIA_PHONE_DEFAULT_DARK_CORE_DATA()                     \
    {                                                                    \
        ...
        .screen_size = ESP_BROOKESIA_STYLE_SIZE_RECT(800, 800),          \
...
#define ESP_BROOKESIA_PHONE_DEFAULT_DARK_CORE_DATA()                     \
    {                                                                    \
        .name = ESP_BROOKESIA_PHONE_DEFAULT_DARK_CORE_INFO_DATA_NAME,    \
        .screen_size = ESP_BROOKESIA_STYLE_SIZE_RECT(720, 720),          \
        .home = ESP_BROOKESIA_PHONE_DEFAULT_DARK_CORE_HOME_DATA(),       \
        .manager = ESP_BROOKESIA_PHONE_DEFAULT_DARK_CORE_MANAGER_DATA(), \
    }
